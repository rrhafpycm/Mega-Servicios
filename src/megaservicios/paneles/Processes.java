...
public class Processes extends javax.swing.JPanel {
    ...
    public Processes() throws IOException {
        ...
        /**********************************************************************/
        String sql="SELECT MAX(Id) FROM procesos";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/42.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/engrane.png"))); // NOI18N
    ...
    private void primerRegistro(){
        ...
        String sql="SELECT MIN(Id) FROM procesos";
        String []datos = new String [1];
    ...
    private void anteriorRegistro(){
        ...
        String sql="SELECT Id FROM procesos"
