...
public class Shopping extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/11.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Amecop", "Nombre", "Piezas", "Costo", "%Oferta", "%Iva", "%Descuento", "Total", "Existencias", "Venta", "Sector"
            }
        ));
    ...
    private void primerRegistro(){
        ...
        String sql="SELECT MIN(Id) FROM compras";
        String []datos = new String [1];
