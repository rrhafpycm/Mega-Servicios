...
public class Transpasos extends javax.swing.JPanel {

    Date d = new Date();
    
    public Transpasos() throws IOException {
        initComponents();
        ...
        /**********************************************************************/
        String sql="SELECT MAX(Id) FROM transpasos";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/16.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Amecop", "Nombre", "Piezas", "Precio", "Valor", "Existencias"
            }
        ));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Enviar" }));
    ...
    private void primerRegistro(){
        ...
        String sql="SELECT MIN(Id) FROM transpasos";
        String []datos = new String [1];
    ...
    private void anteriorRegistro(){
        ...
        String sql="SELECT Id FROM transpasos"
