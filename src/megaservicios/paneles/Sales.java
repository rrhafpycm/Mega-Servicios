...
public class Sales extends javax.swing.JPanel {
    ...
    public void calculoMatematico(){
        DecimalFormat df = new DecimalFormat("0.00");
        
        double descuento = 10.00; //modificar para alterar los descuentos
        double iva = 16.00;
        
        double importe = Double.parseDouble(jLabel13.getText());      
        String importeS = String.valueOf("$ " + df.format(importe));
        jTextField8.setText(importeS);
        
        double subtotal = importe * (descuento/100);
        String subtotalS = String.valueOf("$ " + df.format(subtotal));
        jTextField10.setText(subtotalS);
        
        double resta = importe - subtotal; 
        double ivaq = resta * (iva / 100);
        String ivaqS = String.valueOf("$ " + df.format(ivaq));
        jTextField9.setText(ivaqS);
        
        double total = resta + ivaq;
        String totalS = String.valueOf("$ " + df.format(total));
        jTextField11.setText(totalS);
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1080, 547));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/4.png"))); // NOI18N
    ...
    private void primerRegistro(){
        ...
        String sql="SELECT MIN(Id) FROM ventas";
        String []datos = new String [1];
