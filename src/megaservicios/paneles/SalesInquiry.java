...
public class SalesInquiry extends javax.swing.JPanel {
    ...
    public SalesInquiry() throws IOException {
        initComponents();
        ...
        /**********************************************************************/
        String sql="SELECT MAX(Id) FROM consulta_ventas";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/7.png"))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0; Caja Cero" }));
    ...
    private void primerRegistro(){
        ...
        String sql="SELECT MIN(Id) FROM consulta_ventas";
        String []datos = new String [1];
    ...
    private void anteriorRegistro(){
        ...
        String sql="SELECT Id FROM consulta_ventas"
