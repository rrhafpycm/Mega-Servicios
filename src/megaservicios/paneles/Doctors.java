...
public class Doctors extends javax.swing.JPanel {
    ...
    public Doctors() throws IOException {
        ...
        /**********************************************************************/
        String sql="SELECT MAX(Id) FROM doctores";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/39.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/doctor.png"))); // NOI18N
    ...
    private void primerRegistro(){
        ...
        String sql="SELECT MIN(Id) FROM doctores";
        String []datos = new String [1];
    ...
    private void anteriorRegistro(){
        ...
        String sql="SELECT Id FROM doctores"
