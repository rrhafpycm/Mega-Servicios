...
public class PriceChanges extends javax.swing.JPanel {

    Date d = new Date();
    
    public PriceChanges() throws IOException {
        initComponents();
        ...
        /**********************************************************************/
        String sql="SELECT MAX(Id) FROM cambio_precios";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/12.png"))); // NOI18N
        jLabel1.setText("Cambios de Precios");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fecha", "Amecop", "Nombre", "Publico", "Costo", "%Mar", "%AntPublico", "AntCosto", "%AntMar"
            }
        ));
    ...
    private void primerRegistro(){
        ...
        String sql="SELECT MIN(Id) FROM cambio_precios";
        String []datos = new String [1];
    ...
    private void anteriorRegistro(){
        ...
        String sql="SELECT Id FROM cambio_precios"
