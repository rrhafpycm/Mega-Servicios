...
public class MonthlyReport extends javax.swing.JPanel {
    ...
    public MonthlyReport() throws IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/19.png"))); // NOI18N
        jLabel1.setText("Reporte Mensual");

        jRadioButton1.setText("OLAP Consolidado del mes");

        jRadioButton2.setText("OLAP Consolidado del mes por sector");
        jRadioButton2.setToolTipText("");

        jRadioButton3.setText("Venta del mes por articulo");
