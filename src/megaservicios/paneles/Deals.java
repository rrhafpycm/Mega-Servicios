...
public class Deals extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/13.png"))); // NOI18N
        jLabel1.setText("Ofertas");

        jLabel2.setText("Seleccione el Mayorista:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0; Empresa Mayorista" }));

        jLabel3.setText("Fecha de la ultima sincronización:");

        jLabel4.setText("00:00:00 am 00/00/0000");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Amecop", "Nombre", "Piezas", "% PRC", "P. Oferta", "Texto", "Vigencia"
            }
        ));
    ...
    private void primerRegistro(){
        ...
        String sql="SELECT MIN(Id) FROM ofertas";
        String []datos = new String [1];
    ...
    private void anteriorRegistro(){
        ...
        String sql="SELECT Id FROM ofertas"
