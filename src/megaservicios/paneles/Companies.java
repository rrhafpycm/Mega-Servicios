...
public class Companies extends javax.swing.JPanel {
    ...
    public Companies() throws IOException {
        initComponents();
        ...
        /**********************************************************************/
        String sql="SELECT MAX(Id) FROM compañias";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/33.png"))); // NOI18N
        ...
        jLabel12.setText("Desc.Max:");

        jLabel13.setText("Desc.Nor:");

        jLabel14.setText("Inv.Max:");

        jLabel15.setText("Inv.Min:");
        jLabel15.setToolTipText("");

        jLabel16.setText("Marge Util:");

        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/business-icon1.png"))); // NOI18N

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/company-building-icon.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       buscarCompañia(jTextField100.getText());
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        eliminarCompañia(jTextField100.getText());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
      try {
            ...
            PreparedStatement pst = cn.prepareStatement
              ...
              ("UPDATE compañias SET Id= '" + jTextField100.getText() +
                                "',Compañia= '"+ jTextField6.getText() +
                                "',Nombre='" + jTextField17.getText() +
                                "',Calle='" + jTextField7.getText() +
                                "',Colonia='" + jTextField8.getText() +
                                "',CP='" + jTextField9.getText() +
                                "',Poblacion='" + jTextField1.getText() +
                                "',Telefono='" + jTextField10.getText() +
                                "',Encargado='" + jTextField2.getText() +
                                "',RFC='" + jTextField11.getText() +
                                "',Reg_SSA='" + jTextField3.getText() +
                                "',Desc_Normal='" + jTextField12.getText() +
                                "',Desc_Maximo='" + jTextField4.getText() +
                                "',Inv_Minimo='" + jTextField5.getText() +
                                "',Inv_Maximo='" + jTextField13.getText()+
                                "',Margen_Utilidad= '"+ jTextField14.getText()+
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (rs.isFirst()) {
                JOptionPane.showConfirmDialog(null, "Inicio la tabla");
            }else{
             rs.previous();
                Mostrar(rs);
            }
    ...
    public void Regresar() throws IOException{
        ...
        private void agregarCompañias() {
            try{
                    PreparedStatement pst = cn.prepareStatement("INSERT INTO compañias(Id,Compañia,Nombre,Calle,Colonia,CP,"
                    + "Poblacion,Telefono,Encargado,RFC,Reg_SSA,Desc_Normal,Desc_Maximo,"
                    + "Inv_Minimo,Inv_Maximo,Margen_Utilidad)"
                    ...
                    JOptionPane.showMessageDialog(null, "Se ha agregado una nueva compañia " + jTextField100.getText());
                System.out.println("@---> ++ Se agregado una nueva compañia " + jTextField100.getText() + "();");
        
            }catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "No se ha podido agregar un nuevo articulo ");
            System.out.println("@---> ++ No se puede agregar un nuevo articulo();");
        }
    }
       
       
        private void buscarCompañia(String valor) {
            String sql="";
            String []datos = new String [16];
        
        if(valor.equals("")) {            
            sql="SELECT * FROM compañias";
            JOptionPane.showMessageDialog(null, "No se ha mensionado el identificador la compañia");
        }
        else{
            sql="SELECT * FROM compañias WHERE Id='"+valor+"'";
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Se ha encontrado la compañia");    
                System.out.println("@---> ++ Se ha encontrado la compañia " + jTextField100.getText()+ "();"); 
         
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "No se ha podido encontrar la compañia");
                System.out.println("@---> ++ No se ha podido encontrar el compañia();");                
            }
        }
    }
        
    public void Mostrar(ResultSet rs) throws SQLException {
        ...
        private void eliminarCompañia(String cod) {
            try {
                    PreparedStatement pst = cn.prepareStatement("DELETE FROM compañias WHERE Id='"+cod+"'");
                    pst.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Se han eliminado la compañia");
                    System.out.println("@---> ++ Se han eliminado la compañia " + jTextField100.getText() + "();");
        
            } catch (Exception e) {
                    JOptionPane.showMessageDialog(null, "No se han podido eliminar la compañia");
                    System.out.print("@---> No se han podido eliminar la compañia();");
        }
    }
    
    private void primerRegistro(){
        
        String sql="SELECT MIN(Id) FROM compañias";
        String []datos = new String [1];
    ...
    private void anteriorRegistro(){
        ...
        String sql="SELECT Id FROM compañias"
                +" WHERE Id < " +jTextField100.getText() 
                +" ORDER BY Id DESC"
                + " LIMIT 1;" ;
        String []datos = new String [1];
