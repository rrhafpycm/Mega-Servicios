...
public class Exports extends javax.swing.JPanel {

    Date d = new Date();
    
    public Exports() throws IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/megaservicios/img/25.png"))); // NOI18N
        jLabel1.setText("Exportaciones");

        jRadioButton4.setText("Toma de Inventarios, MARZAM");
        jRadioButton4.setToolTipText("");

        jRadioButton2.setText("Articulos, compañias");

        jRadioButton1.setText("Catalogo del clientes, compañias");

        jRadioButton3.setText("Articulos compañias, CVS");
